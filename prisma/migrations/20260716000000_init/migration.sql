...
-- CreateIndex
CREATE INDEX "idx_gps_logs_user_id" ON "gps_logs"("user_id");

-- CreateIndex
CREATE INDEX "idx_maintenance_templates_assigned_to" ON "maintenance_templates"("assigned_to");

-- CreateIndex
CREATE INDEX "idx_maintenance_occurrences_assigned_to" ON "maintenance_occurrences"("assigned_to");

-- CreateIndex
CREATE INDEX "idx_maintenance_occurrences_scheduled_date" ON "maintenance_occurrences"("scheduled_date");

-- CreateIndex
CREATE INDEX "idx_maintenance_occurrences_status" ON "maintenance_occurrences"("status");

-- CreateIndex
CREATE INDEX "idx_maintenance_occurrences_template_id" ON "maintenance_occurrences"("template_id");

-- CreateIndex
CREATE INDEX "idx_accrued_values_month_year" ON "accrued_values"("month", "year");

-- CreateIndex
CREATE INDEX "idx_accrued_values_user_id" ON "accrued_values"("user_id");
